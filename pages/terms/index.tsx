...
const TermsOfUse = () => {
  return (
    <Box maxW="800px" mx="auto" py="6" px="4">
      ...
      <Text mb="3">
        PenpalMap provides a platform enabling individuals from all over the
        world to connect and communicate. We value and uphold your privacy,
        ensuring you can interact with other members on our platform. By posting
        or uploading content potentially protected by intellectual property
        rights, you expressly grant us a non-exclusive, transferable,
      ...
      <List spacing={2}>
        <ListItem>
          ...
          personal photos to complete your profile. These photos can be centered
          on a specific part of the image according to your choice, and you can
          upload several to display on your profile.
        </ListItem>
        <ListItem>
        ...
        <ListItem>
          ...
          non-exclusive, transferable, sublicensable, free, worldwide license to
          use, reproduce, distribute, and display this photo in relation to
          PenpalMap&apos;s services.
        </ListItem>
        <ListItem>
          Prohibition of Scraping: It&apos;s strictly forbidden to scrape or
          download photos of other PenpalMap users without their explicit
          consent.
        </ListItem>
        <ListItem>
          Photo Protection: We&apos;re committed to safeguarding your photos on
          our servers. Though, the transmission of data over the internet is not
          always entirely secure.
        </ListItem>
        <ListItem>
          Privacy Respect: Photos of others were taken with explicit consent. If
          the photo was taken in a private place, you obtained the owner&apos;s
          consent.
        </ListItem>
        <ListItem>
      ...
      <Text mb="3">
        You can register as a member of the PenpalMap community. Follow the
      ...
      <Text mb="3">
        PenpalMap may terminate your access to all or part of the PenpalMap
        ...
        account, you can delete your account from your account profile settings.
      </Text>
      ...
      <Text mb="3">
        ...
        PenpalMap disclaims all responsibility for the accuracy, quality,
      ...
      <Text mb="3">
        PenpalMap reserves the right to change the terms of use with appropriate
        notice of at least six weeks.
      </Text>
